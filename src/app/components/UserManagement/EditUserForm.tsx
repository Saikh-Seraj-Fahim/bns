...
export default function EditUserForm({ user, onBack }: EditUserFormProps) {
    ...
    const [date, setDate] = useState<Date | undefined>(
        user.dob ? new Date(user.dob) : undefined  // pre-populate date state from user
    );
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="mx-16 my-8 p-5 border shadow-lg rounded-lg">
                                    ...
                                    <Popover open={open} onOpenChange={setOpen}>
                                        <PopoverTrigger asChild>
                                            <Button
                                                ...
                                                font-nunito text-[#313131] cursor-pointer"
                                            >
